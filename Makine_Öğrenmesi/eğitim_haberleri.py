...
try:
    ...
    with open("egitim_haberleri.csv", mode="w", encoding="utf-8", newline="") as file:
        ...
        for page_num in range(1, 6):
            # Sayfayı aç
            url = f"https://www.milliyet.com.tr/egitim/?page={page_num}"
            driver.get(url)
            ...
            for haber in haberler:
                writer.writerow([haber.text, "Eğitim"])
